...
2. Use the `execute_sparql_query` tool to execute it.
3. Read the JSON results.
4. Provide a clear, detailed security explanation based on the returned data. Explain *why* the findings matter from a threat intelligence or SOC perspective (just like a real analyst would).
"""
...
def main():
    ...
    if not os.environ.get("GOOGLE_API_KEY"):
        print("Error: GOOGLE_API_KEY is not set. Please set it in your .env file or export it in your terminal.")
        return
